...
void main() {
  group('RestException', () {
    ...
    final StackTrace mockStackTrace = StackTrace.fromString('This is the stacktrace.');

    test('Should return a RestException with errorMessage, verb and requestUri.', () {
      // Act
    ...
    test('Should return a RestException with errorMessage, verb, requestHeaders and requestUri.', () {
      // Act
      final RestException exception = RestException(
        errorMessage: mockErrorMessage,
        method: mockVerb,
    ...
    test('Should return a RestException with errorMessage, verb, requestHeaders, requestUri and requestBody.', () {
      // Act
      final RestException exception = RestException(
        errorMessage: mockErrorMessage,
        method: mockVerb,
    ...
    test('Should return FALSE when two RestException objets are different.', () {
      // Act
      final RestException exception1 = RestException(
        errorMessage: 'This is an error.',
        method: RestMethod.patch,
    ...
    test('Should return the string representantion of a RestException object when toString() method is called.', () {
      // Arrange
      final RestException exception = RestException(
        errorMessage: 'This is an error.',
    ...
    test('Should return two equals hashcode when two RestException objets are equals.', () {
      // Arrange
      final RestException exception1 = RestException(
        errorMessage: 'This is an error.',
        method: RestMethod.patch,
    ...
    test('Should return two different hashcode when two RestException objets are different.', () {
      // Arrange
      final RestException exception1 = RestException(
        errorMessage: 'This is an error.',
        method: RestMethod.patch,
